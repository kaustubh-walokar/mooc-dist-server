...
public class ConnectionManager {
	...
	//interCluster
	//private static HashMap<Integer,Channel> interConnect = new HashMap<>();
	...
	public synchronized static void	sendTo(Integer node , Management mgmt){
		if (mgmt == null)
			return;
		if(mgmtConnections.containsKey(node))
			mgmtConnections.get(node).write(mgmt);
		else
			logger.warn("No such node added");
	}
