...
//    Election leader;
        ...
        public Raft() {
//            leader = new RaftLeader();
//            follower = new RaftFollower();
//            candidate = new RaftCandidate();
            state= follower;
    ...
    public Management process(Management mgmt) {
        ...
        if (requset.getAction().getNumber() == ElectAction.DECLAREELECTION_VALUE) {
            ...
            this.clear();
            notifySuccessfulLeader(false, null);
            ...
            notifySuccessfulLeader(true, requset.getCandidateId());
            ...
            if (abstainCount >= ((ConnectionManager.getNumMgmtConnections() + 1) / 2) + 1) {
                ...
                notifySuccessfulLeader(false, this.nodeId);
            ...
            if (requset.getCandidateId() == this.nodeId) {
                ...
                if (voteCount >= ((ConnectionManager.getNumMgmtConnections() + 1) / 2) + 1) {
                    ...
                    notifySuccessfulLeader(true, this.nodeId);
...
//			rtn = castVote(mgmt, isNew);
    ...
    private void notifySuccessfulLeader(boolean success, Integer leader) {
        if (eListener != null)
