...
def sendSomething():
    ...
    r.header.routing_id = 2
    r.header.originator = 300

    r.body.ping.number = 1
    r.body.ping.tag = "kasutubh"
...
if __name__ == '__main__':
    ...
    result = sendMsg(message,port,host)
    print result
    # if input == "1":
    ...
    #     result = sendMsg(buildHello(),5570,"localhost")
    #     #result = sendMsg("test",port,host)
